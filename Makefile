...
OBJS= amazon.o user.o db_parser.o product.o product_parser.o util.o amazonDataStore.o book.o movie.o clothing.o
...
amazonDataStore.o: amazonDataStore.cpp amazonDataStore.h
